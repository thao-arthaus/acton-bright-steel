document.addEventListener("DOMContentLoaded", function() {
  ...
  function bottomPagePadding() {
    var footerBig = document.getElementById('footer'),
        ...
        bodyBig.style.paddingBottom = window.getComputedStyle(footerBig, null).getPropertyValue("height");
  }
  bottomPagePadding();
});
...
function mobileNavMenuShow() {
  var navElement = document.getElementById('navElement'),
      ...
      productsTechnicalElement = document.getElementById('productInnerTechnicalElement'),
      productsUsefulElement = document.getElementById('productInnerUsefulElement');
...
function innerMobileNavMenuShowTechnical() {
  var productsTechnicalElement = document.getElementById('productInnerTechnicalElement');
  ...
  document.addEventListener('click' ,function(e) {
    ...
    // Check if nav has mobile nav class and toggle
    if (productsTechnicalElement.className.match(/\bnav__inner-wrap--mobile\b/)) {
      productsTechnicalElement.classList.remove("nav__inner-wrap--mobile");
    } else {
...
function displaydisclaimer() {
  var disclaimer = document.getElementsByClassName('disclaimer')[0],
      disclaimerCloseButton = document.getElementsByClassName('disclaimer__box__close')[0],
      disclaimerOpenButton = document.getElementsByClassName('footer__site-info__text--disclaimer')[0];
